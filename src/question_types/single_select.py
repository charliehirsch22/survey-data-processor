"""
Single select question type processor.

This module handles the setup and formatting of standard single select questions.
"""
...
from ..data_extractors.data_map_extractor import extract_response_options
